...
public:
	...
	void fetchEntity(EntityUniqueID, bool) const;
	void getRuntimeEntity(EntityRuntimeID, bool) const;
	...
	void getEntities(DimensionId, EntityType, AABB const&, std::vector<Entity*, std::allocator<Entity*> >&, bool);
	...
	void getNearestAttackablePlayer(BlockPos, float, Entity*);
	...
	void getAutonomousEntity(EntityUniqueID) const;
